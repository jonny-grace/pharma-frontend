...
const RegisterPharmaciest = () => {
  ...
  const handleInputChange = (e) => {
    ...
    setPharmaciest((prevpharmaciest) => ({
      ...prevpharmaciest,
      [name]: value,
    }));
  };
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        `${process.env.NEXT_PUBLIC_API_URL}/admin/register/pharmaciest/`,
        pharmaciest,
        {
          headers: {
      ...
      .then((response) => {
        ...
        alert("Pharmaciest registered successfully");
        router.push("/admin");
    ...
    // Perform further actions with the pharmaciest' data
  };
...
export default RegisterPharmaciest;
