...
const RegisterNurse = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        `${process.env.NEXT_PUBLIC_API_URL}/admin/register/nurse/`,
        nurses,
        {
          headers: {
    ...
    // Perform further actions with the nurses' data
  };
